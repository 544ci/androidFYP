...
public class App extends Application {
    public static final String SERVER_ADDRESS = "http://192.168.10.36:3580";
    ...
    public static final String GET_STREAM_STATUS_URL = SERVER_ADDRESS + "/api/requests/streamStatus";

    public static final String GET_ENCRYPTIONKEY_URL = SERVER_ADDRESS + "/api/usermanagement/getencryptionkey";
    ...
    public static final long GET_STREAM_STATUS_INTERVAL = 10000;
    ...
    public static final String[] FILES_TYPES_TO_ENCRYPT = new String[]{"jpg", "png","mp4","mp3"};
    ...
    public static final String STREAM_URL = "rtmp://192.168.10.36/live/";
